...
public class Personajes {
	...
	public void CojerObjeto(int pos, Localizaciones place) {
		...
		for(contadorObjetosPlace = 0; place.getOneName(contadorObjetosPlace)!= null ;contadorObjetosPlace++) {
			if(place.getOneName(contadorObjetosPlace).equalsIgnoreCase(objetoAcoger)) {
				placePos = contadorObjetosPlace;
			}
		}
		this.objects[contadorObjetos] = place.getOneObject(contadorObjetosPlace);
